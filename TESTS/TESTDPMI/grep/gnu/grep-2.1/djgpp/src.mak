...
install-binPROGRAMS: $(bin_PROGRAMS)
	...
	$(INSTALL_PROGRAM) grep $(bindir)/grep
	$(INSTALL_PROGRAM) egrep.exe $(bindir)/egrep.exe
	$(INSTALL_PROGRAM) fgrep.exe $(bindir)/fgrep.exe
...
TAGS:  $(HEADERS) $(SOURCES)  $(TAGS_DEPENDENCIES)
	etags $(ETAGS_ARGS) $$tags  $(SOURCES) $(HEADERS)
